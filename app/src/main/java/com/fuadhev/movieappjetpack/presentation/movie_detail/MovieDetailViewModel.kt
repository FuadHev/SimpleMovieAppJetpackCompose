...
import com.fuadhev.movieappjetpack.domain.usecase.GetMovieDetailUseCase
import com.fuadhev.movieappjetpack.presentation.movies.MovieState
...
class MovieDetailViewModel @Inject constructor(
    ...
    private fun getMovieDetail(imdbId: String) {
        getMovieDetailUseCase.getMovieDetail(imdbId).onEach {
            when (it) {
                is Resource.Success -> {
                ...
                is Resource.Error -> {
                    _state.value = MovieDetailState(error = it.exception ?: "Error!")
